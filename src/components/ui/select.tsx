...
function SelectGroup({ className, ...props }: SelectPrimitive.Select.Group.Props) {
  return (
    <SelectPrimitive.Select.Group
...
function SelectValue({ className, ...props }: SelectPrimitive.Select.Value.Props) {
  return (
...
function SelectTrigger({
  ...
  children,
  ...props
}: SelectPrimitive.Select.Trigger.Props & {
  size?: "sm" | "default"
}) {
  return (
...
function SelectContent({
  ...
  ...props
}: SelectPrimitive.Select.Popup.Props &
  Pick<
...
function SelectLabel({
  className,
  ...props
}: SelectPrimitive.Select.GroupLabel.Props) {
  return (
...
function SelectItem({
  ...
  children,
  ...props
}: SelectPrimitive.Select.Item.Props) {
  return (
...
function SelectSeparator({
  className,
  ...props
}: SelectPrimitive.Select.Separator.Props) {
  return (
